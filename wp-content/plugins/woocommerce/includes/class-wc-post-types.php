			...
			apply_filters( 'woocommerce_register_post_type_shop_order',
				array(
					'labels'              => array(
							...
							'add_customer'       	=> __( 'Add Customer', 'woocommerce' ),
							'add_both'      		=> __( 'Add Distributor / Customer', 'woocommerce' ),
							'pay_invoice'      		=> __( 'Payment Information', 'woocommerce' ),
							'check_payment'      	=> __( 'Check Payment', 'woocommerce' ),
							'report'    		  	=> __( 'Report', 'woocommerce' ),
