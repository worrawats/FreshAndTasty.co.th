...
class ElatedIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new ElatedIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new ElatedIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new ElatedIconsIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new ElatedIconsLineaIcons('Linea Icons', 'linea_icon'));
    }
...
$eltdIconCollections = ElatedIconCollections::get_instance();
