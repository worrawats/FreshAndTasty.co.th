        ...
        <div style="<?php if(!$icon_options_visible) { echo 'display: none;'; } ?>" id="<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>-container">
            ...
            <p>
                ...
                <select id="<?php echo esc_attr($this->get_field_id( 'icon_position' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'icon_position' )); ?>">
                    <option value="top" <?php if(esc_attr($icon_position) == "top"){echo 'selected="selected"';} ?>><?php _e('Default/Top', 'eltd') ?></option>
                    <option value="middle" <?php if(esc_attr($icon_position) == "middle"){echo 'selected="selected"';} ?>><?php _e('Middle', 'eltd') ?></option>
...
function eltd_call_to_action_load_widget(){
	register_widget('Elated_Call_To_Action');
}

add_action('widgets_init', 'eltd_call_to_action_load_widget');
