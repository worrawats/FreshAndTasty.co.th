    ...
    <div class="full_screen_preloader">
        ...
        if($eltd_options['loading_animation'] == "on") {
            if($eltd_options['loading_image'] != "") { ?>
                <div class="ajax_loader"><div class="ajax_loader_1"><div class="ajax_loader_2"><img src="<?php echo esc_url($eltd_options['loading_image']) ?>" alt="" /></div></div></div>
            <?php }
            else { ?>
                <div class="ajax_loader"><div class="ajax_loader_1"><?php eltd_loading_spinners(); ?></div></div>
            <?php }
        }
        ?>
    </div>

    <div class="full_screen_holder"<?php eltd_inline_style($full_screen_holder_style); ?>>
        <div class="full_screen_inner" <?php eltd_inline_style($content_style); ?>>
