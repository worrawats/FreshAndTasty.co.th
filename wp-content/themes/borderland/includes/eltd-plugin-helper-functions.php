...
if(!function_exists('eltd_is_woocommerce_installed')) {
	/**
	 * Function that checks if woocommerce is installed
	 * @return bool
	 */
	function eltd_is_woocommerce_installed() {
		return function_exists('is_woocommerce');
	}
}

if(!function_exists('eltd_is_woocommerce_page')) {
	/**
	 ...
	 * @see is_woocommerce()
	 */
	function eltd_is_woocommerce_page() {
		return function_exists('is_woocommerce') && is_woocommerce();
	}
}

if(!function_exists('eltd_is_woocommerce_shop')) {
	/**
	 ...
	 * @see is_shop()
	 */
	function eltd_is_woocommerce_shop() {
		return function_exists('is_shop') && is_shop();
	}
}

if(!function_exists('eltd_get_woo_shop_page_id')) {
	/**
	 * Function that returns shop page id that is set in WooCommerce settings page
	 * @return int id of shop page
	 */
	function eltd_get_woo_shop_page_id() {
...
if(!function_exists('eltd_is_product_category')) {
	function eltd_is_product_category() {
		return function_exists('is_product_category') && is_product_category();
	}
}

if(!function_exists('eltd_load_woo_assets')) {
	/**
	 * Function that checks whether WooCommerce assets needs to be loaded.
	 *
	 * @see eltd_is_ajax_enabled()
	 * @see eltd_is_woocommerce_page()
	 * @see eltd_has_woocommerce_shortcode()
	 * @see eltd_has_woocommerce_widgets()
	 * @return bool
	 */

	function eltd_load_woo_assets() {
		return eltd_is_woocommerce_installed() && (eltd_is_ajax_enabled() || eltd_is_woocommerce_page() ||
			eltd_has_woocommerce_shortcode() || eltd_has_woocommerce_widgets());
	}
}

if(!function_exists('eltd_has_woocommerce_shortcode')) {
	/**
	 * Function that checks if current page has at least one of WooCommerce shortcodes added
	 * @return bool
	 */
	function eltd_has_woocommerce_shortcode() {
		...
		foreach ($woocommerce_shortcodes as $woocommerce_shortcode) {
			$has_shortcode = eltd_has_shortcode($woocommerce_shortcode);
...
if(!function_exists('eltd_has_woocommerce_widgets')) {
	/**
	 * Function that checks if current page has at least one of WooCommerce shortcodes added
	 * @return bool
	 */
	function eltd_has_woocommerce_widgets() {
		$widgets_array = array(
...
if(!function_exists('eltd_get_woocommerce_pages')) {
	/**
	 ...
	 * @version 0.1
	 */
	function eltd_get_woocommerce_pages() {
...
if(!function_exists('eltd_woocommerce_columns_class')) {
	/**
	 ...
	 */
	function eltd_woocommerce_columns_class($classes) {
		global $eltd_options;

		if (in_array("woocommerce", $classes)) {
			$products_list_number = 'columns-3';
			if(isset($eltd_options['woo_products_list_number'])){
				$products_list_number = $eltd_options['woo_products_list_number'];
			}
	...
	add_filter('body_class', 'eltd_woocommerce_columns_class');
}
...
if(!function_exists('eltd_visual_composer_installed')) {
	/**
	 * Function that checks if visual composer installed
	 * @return bool
	 */
	function eltd_visual_composer_installed() {
...
if(!function_exists('eltd_visual_composer_custom_shortcodce_css')) {
	/**
	 * Function that adds Visual composer's custom css to our action. Needed for ajax page transitions
	 */
	function eltd_visual_composer_custom_shortcodce_css() {
		if(eltd_visual_composer_installed()) {
			if(is_page() || is_single() || is_singular('portfolio_page')) {

				$shortcodes_custom_css = get_post_meta( eltd_get_page_id(), '_wpb_shortcodes_custom_css', true );
				if ( ! empty( $shortcodes_custom_css ) ) {
					echo '<style type="text/css" data-type="vc_shortcodes-custom-css-'.esc_attr(eltd_get_page_id()).'">';
					echo get_post_meta( eltd_get_page_id(), '_wpb_shortcodes_custom_css', true );
					echo '</style>';
				}

				$post_custom_css = get_post_meta( eltd_get_page_id(), '_wpb_post_custom_css', true );
				if ( ! empty( $post_custom_css ) ) {
					echo '<style type="text/css" data-type="vc_custom-css-'.esc_attr(eltd_get_page_id()).'">';
					echo get_post_meta( eltd_get_page_id(), '_wpb_post_custom_css', true );
					echo '</style>';
				}
			}
		}
	...
	add_action('eltd_visual_composer_custom_shortcodce_css', 'eltd_visual_composer_custom_shortcodce_css');
}

/*=================================================================================
 * #Yoast helper functions
 *=================================================================================*/
if(!function_exists('eltd_seo_plugin_installed')) {
	/**
	 * Function that checks if popular seo plugins are installed
	 * @return bool
	 */
	function eltd_seo_plugin_installed() {
		//is YOAST installed?
...
if(!function_exists('eltd_remove_yoast_json_on_ajax')) {
    /**
     ...
     * @version 0.2
     */
    function eltd_remove_yoast_json_on_ajax($data) {
    ...
    if(defined('WPSEO_VERSION') && version_compare(WPSEO_VERSION, '1.6') >= 0) {
        add_filter('wpseo_json_ld_output', 'eltd_remove_yoast_json_on_ajax');
    }
}
 ...
 *=================================================================================*/
if(!function_exists('eltd_contact_form_7_installed')) {
	/**
	 * Function that checks if contact form 7 installed
	 * @return bool
	 */
	function eltd_contact_form_7_installed() {
...
if(!function_exists('eltd_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function eltd_get_wpml_pages_for_current_page() {
