...
if( ! class_exists( 'eltd_sidebar' ) ){
	...
	class eltd_sidebar{
		...
		function load_assets(){
			...
			wp_enqueue_script('eltd_sidebar' , ELTD_ROOT . '/framework/admin/assets/js/eltdf-sidebar.js');
			wp_enqueue_style( 'eltd_sidebar' , ELTD_ROOT . '/framework/admin/assets/css/eltdf-sidebar.css');
		}
		...
		function template_add_widget_field(){
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".__('Enter Name of the
			new Widget Area', 'eltd')."' name='eltd-add-widget' /></span>";
