...
if(!function_exists('eltd_register_sidebars')) {
    ...
    function eltd_register_sidebars() {
        ...
        if (isset($eltd_options['center_logo_image'])){ if($eltd_options['center_logo_image'] == "yes") { $centered_logo = true; }};
        if(isset($eltd_options['header_bottom_appearance']) && $eltd_options['header_bottom_appearance'] == "fixed_hiding"){
            $centered_logo = true;
        }
...
if(!function_exists('eltd_add_support_custom_sidebar')) {
    /**
     * Function that adds theme support for custom sidebars. It also creates eltd_sidebar object
     */
    function eltd_add_support_custom_sidebar() {
        add_theme_support('eltd_sidebar');
        if (get_theme_support('eltd_sidebar')) new eltd_sidebar();
    }
