...
class Elated_Import {
    ...
    function eltd_admin_import() {
        ...
        add_action('admin_print_scripts-'.$this->pagehook, 'eltd_enqueue_admin_scripts');
        add_action('admin_print_styles-'.$this->pagehook, 'eltd_enqueue_admin_styles');
...
$eltd_import_object = new Elated_Import();
