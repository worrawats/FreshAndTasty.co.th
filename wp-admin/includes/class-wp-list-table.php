...
<?php
	...
	protected function bulk_actions( $which = '' ) {
		...
		?>
			if(this.value=='wcdn_print_invoice')
			{
		...
		<?php
		echo '" name="action' . $two . '" id="bulk-action-selector-' . esc_attr( $which ) . "\">\n";
		...
		{
			submit_button( __( 'Create Invoice' ), 'action', '', false, array( 'id' => "doaction$two" ) );
		}
		else{
...
<?php
	...
	public function display_rows_or_placeholder() {
		if ( $this->has_items() ) {
			...
			else{echo '<tr class="no-items"><td class="colspanchange" colspan="' . $this->get_column_count() . '">';}
			$this->no_items();
			echo '</td></tr>';
		}
	}
