...
if ( 'post' != $post_type ) {
	...
	$register = "register.php?post_type=$post_type";
} else {
...
if ($post_type=='shop_order')
{
	...
	{
		echo ' <a href="/freshandtasty/registration/" class="page-title-action" >' . esc_html( $post_type_object->labels->add_both ) . '</a>';
		echo ' <a href="/freshandtasty/check-payment/" class="page-title-action" target="_blank">' . esc_html( $post_type_object->labels->check_payment ) . '</a>';
		echo ' <a href="/freshandtasty/report/" class="page-title-action" target="_blank">' . esc_html( $post_type_object->labels->report ) . '</a>';
	}
	else if($user->roles[0]=="shop_manager")
	{
		echo ' <a href="/freshandtasty/registration/" class="page-title-action" >' . esc_html( $post_type_object->labels->add_customer ) . '</a>';
		echo ' <a href="/freshandtasty/payment/" class="page-title-action" >' . esc_html( $post_type_object->labels->pay_invoice ) . '</a>';
		echo '<STYLE type="text/css"> div#adminmenumain, div#screen-meta-links, div.update-nag {display:none} th#order_actions, td.order_actions, th.column-order_actions {display:none} div#wpcontent{margin-left:0 !important}</STYLE>';
	}
}
...
<?php $wp_list_table->search_box( $post_type_object->labels->search_items, 'post' ); ?>
	<input type="hidden" name="author" class="author" value="<?php echo get_current_user_id(); ?>" />
